...
// Verificar se deve exibir o popup com base nas configurações e na sessão
$adminSettings = new AdminSettings();
$showPopupSetting = $adminSettings->getSetting('popup_enabled', '0') == '1';

// A principal mudança está aqui:
// O popup só será exibido se a configuração do admin permitir E se ele ainda não foi mostrado nesta sessão.
$showPopup = $showPopupSetting && (!isset($_SESSION['popup_shown_this_session']) || !$_SESSION['popup_shown_this_session']);

// Se o popup for exibido, marque-o como exibido para esta sessão
if ($showPopup) {
    $_SESSION['popup_shown_this_session'] = true;
}
