...
class Database {
    ...
    private $charset = 'utf8mb4'; // Já está configurado para utf8mb4, o que é bom
    ...
    public function createTables() {
		...
		(`id`, `username`, `password`, `email`, `role`, `status`, `expires_at`, `credits`, `parent_user_id`, `created_at`, `updated_at`, `last_login`) 
		VALUES 
		(NULL, 'admin', '$2y$10$whV/hWHt8BdzIW9BYpjDVeVTluBdwV00GuH3DV8N/VkG8D2bx19pS', '', 'admin', 'active', NULL, '0', NULL, '2025-06-25 21:47:47', '2025-07-01 21:09:07', '2025-07-01 21:09:07');
        ";
