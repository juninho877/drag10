        ...
        * {
        ...
        @media (max-width: 1024px) {
            ...
            .sidebar-footer {
                ...
                padding-bottom: calc(1rem + env(safe-area-inset-bottom)); /* Extra space for mobile nav bars */
                margin-bottom: 60px; /* Space for mobile browser bottom bar */
            }
        ...
        @media (max-width: 640px) {
            ...
            .sidebar-footer {
                ...
                margin-bottom: 80px; /* Extra space for iPhone bottom bar */
            }
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                ...
                <div class="header-controls">
                    <button class="mobile-close-btn" id="mobileCloseBtn" onclick="
        ...
        <main class="main-content" id="mainContent">
            ...
            <header class="top-header">
                <div class="header-left">
                    <button class="mobile-menu-btn" id="mobileMenuBtn" onclick="
                        var sidebar = document.getElementById('sidebar');
                        var overlay = document.getElementById('overlay');
